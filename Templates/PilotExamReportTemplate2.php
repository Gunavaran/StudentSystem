    ...
    <div id="wrapper">
        ...
        <div id="content_area">
            <div id = resultbar>
                ...
                if ($_SESSION['option'] == 'individual'){
                    include '../PilotExam/PilotReportIndividual.php';
                    ?>

                    <nav id="ok" style="margin-top: 0px; padding-top: 0px">
                        <ul id="nav" style="margin-top: 0px">
                            <li id = 'compLine' style="font-size: 20px; margin-top: 15px; margin-left: 70px"> <a href="PilotExamReportTemplate0.php"> OK </a></li>
                        </ul>
                    </nav>
                    <?php
                } else {
                    include "../PilotExam/PilotReportDivision.php";
                    ?>
                    <nav id="ok" style="margin-top: 0px; padding-top: 0px">
                        <ul id="nav" style="margin-top: 0px">
                            <li id = 'compLine' style="font-size: 20px; margin-top: 15px; margin-left: 70px"> <a href="PilotExamReportTemplate0.php"> OK </a></li>
